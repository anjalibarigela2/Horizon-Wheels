        ...
        <div>
          <div className="space-y-6 max-w-xl mx-auto">
            ...
            <p data-aos="fade-up" className="text-center sm:px-20">
              Your next ride is just a tap away. Experience hassle-free car rentals right from your phone with our app
            </p>
            <p data-aos="fade-up" className="text-center sm:px-20">
              Download our app now on Play Store or App Store.
            </p>
            <div
              data-aos="fade-up"
